...
public class BookBuyConfirm extends BaseFragment
    ...
    protected void init(View paramView) {
        ...
        this.tvBookIntro.setText("Bạn sẽ bị trừ 40.000đ vào tài khoản. Bạn có muốn tiếp tục thực hiện giao dịch không ?");
        this.tvBookIntro.setTextColor(getResources().getColor(R.color.orange));
        this.tvBuyNow.setText("ĐỒNG Ý");
    }
    ...
    public void onClick(View paramView) {
        switch (paramView.getId()) {
            ...
            case R.id.tvDoAfter:
                ...
                break;
            case R.id.tvBuyNow:
                EventBus.getDefault().post(new OnEventOpenBuyBookDialog(OnEventOpenBuyBookDialog.SCRN_BUY_BOOK_FAILED));
        }
    }
